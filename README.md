...
### Локальная AI-платформа — 12 инструментов, один интерфейс
...
Eclipse AI Hub — единая платформа для работы с AI-моделями. 12 специализированных инструментов в одном интерфейсе. Подключите свою модель (локальную через Ollama или облачную) — и все инструменты используют её.

**Ключевая идея:** пользователь подключает СВОЮ модель один раз в настройках — и все 12 модулей работают через неё.

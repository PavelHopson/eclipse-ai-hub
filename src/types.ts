...
export type ModuleId = 'chat' | 'arena' | 'rag' | 'growth-os' | 'editor-stylist' | 'deck-studio' | 'ai-builder' | 'research-room' | 'ads-audit' | 'model-registry' | 'code-review' | 'copywriter' | 'security-scan' | 'image-studio';
